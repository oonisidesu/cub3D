...
SRCS = src/main.c \
       ...
       src/validate/validate_args.c src/validate/validate_line.c src/validate/validate_map_wall_util.c src/validate/validate_map_wall.c src/validate/validate_map.c
