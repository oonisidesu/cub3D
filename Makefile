...
SRCS = src/main.c \
       ...
       src/game/game_calculate.c src/game/game_draw.c src/game/game_handler.c src/game/game_move.c src/game/game_play.c src/game/game_render.c \
       src/gnl/get_next_line.c src/gnl/get_next_line_utils.c \
       src/init/init_data.c src/init/init_texture.c \
